...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors
                .basePackage("com.lambdaschool.pintreach"))
    ...
    {
        return new ApiInfoBuilder().title("Pintreach Model Example")
            .description("Pintreach Model Example")
            .contact(new Contact("Lauren Emick",
                "http://www.lambdaschool.com",
                "laurenemick6@gmail.com"))
            .license("MIT")
